<?php
/**
 * Page Organigramme - Présentation du laboratoire et des équipes
 * À placer dans : views/visitor/organigramme.php
 */
            ...
            <div class="presentation-content">
                ...
                <div class="themes-grid">
                    <div class="theme-card">
                        ...
                        <p>Machine Learning, Deep Learning, Vision par Ordinateur, Traitement du Langage Naturel</p>
                    </div>
                    <div class="theme-card">
                        <h4>Développement Web</h4>
                        <p>Architectures Cloud, Progressive Web Apps, Frameworks Modernes, Performance Web</p>
                    </div>
                    <div class="theme-card">
                        <h4>Cybersécurité</h4>
                        <p>Sécurité des Réseaux, Cryptographie, Détection d'Intrusions, Sécurité Applicative</p>
                    </div>
                    <div class="theme-card">
                        <h4>IoT & Systèmes Embarqués</h4>
                        <p>Internet des Objets, Systèmes Temps Réel, Edge Computing, Capteurs Intelligents</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="directeur-section">
                ...
                <div class="membre-card-horizontal directeur-card">
                    <div class="membre-avatar-large">
                        <?php if (!empty($directeur['photo'])): ?>
                            <img src="<?= base_url('uploads/' . $directeur['photo']) ?>" 
                                 alt="<?= e($directeur['nom']) ?>">
                        <?php else: ?>
                            <div class="avatar-placeholder-large">
                                <?= strtoupper(substr($directeur['nom'] ?? 'D', 0, 2)) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="membre-info-horizontal">
                        <div class="membre-header">
                            <h4>
                                <a href="<?= base_url('membres/' . $directeur['id']) ?>">
                                    <?= e($directeur['nom']) ?>
                                </a>
                            </h4>
                            <span class="badge-directeur">Directeur</span>
                        </div>
                        <?php if (!empty($directeur['grade'])): ?>
                        <div class="membre-grade"><?= e($directeur['grade']) ?></div>
                        <?php endif; ?>
                        <?php if (!empty($directeur['biographie'])): ?>
                        <p class="membre-bio"><?= truncate($directeur['biographie'], 200) ?></p>
                        <?php endif; ?>
                        <div class="membre-actions">
                            <?php if (!empty($directeur['email'])): ?>
                            <a href="mailto:<?= e($directeur['email']) ?>" class="btn-link">Contact</a>
                            <?php endif; ?>
                            <a href="<?= base_url('membres/' . $directeur['id']) ?>" class="btn-primary">Voir profil</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="detail-card equipes-section">
            ...
            <div class="equipes-filters">
                ...
                <select id="filter-domaine" class="filter-select">
                    ...
                    <?php
                    $domaines = array_unique(array_filter(array_column($equipes, 'domaine')));
                    sort($domaines);
                    ...
                    <?php foreach ($equipes as $equipe): ?>
                        ...
                        <div class="equipe-card" 
                                ...
                                <div class="membre-card-inline">
                                    <div class="membre-avatar-small">
                                        <?php if (!empty($chef['photo'])): ?>
                                            <img src="<?= base_url('uploads/' . $chef['photo']) ?>" 
                                                 alt="<?= e($chef['username']) ?>">
                                        <?php else: ?>
                            ...
                            <div class="membres-equipe-section">
                                <h4>Membres de l'équipe (<?= count($membresEquipe) ?>)</h4>
